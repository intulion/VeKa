...
import kotlinx.android.synthetic.main.view_photo_post.view.*
import kotlin.math.max

class PhotoPostLayout @JvmOverloads constructor(
    context: Context?,
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.view_photo_post, this, true)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        height += postPhoto.getHeightWithMargins()
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        // 3. Photo
        currentLeft = leftWithPadding
        postPhoto.layoutWithMargins(
            currentLeft, currentTop,
            rightWithPadding, postPhoto.measuredHeight
        )
        currentTop += postPhoto.getHeightWithMargins()
    ...
    override fun bindPost(post: Post, callback: PostEventCallback) {
        ...
        postPhoto.setOnClickListener { callback.onPhotoClicked(post) }
